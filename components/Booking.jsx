...
import { checkInApartment, claimFunds, refundBooking } from '@/services/blockchain'
...
const TenantView = ({ booking, functions, owner, apartmentOwner }) => {
  return (
    <div className="w-full flex justify-between items-center my-3 bg-gray-100 p-3">
      ...
      {/* {owner == apartmentOwner && !booking.cancelled && !booking.checked && (
        <button
          className="p-2 bg-green-500 text-white font-medium italic
        rounded-full text-sm px-4"
        >
